...
import TeacherCopilotClient from '@/components/nipun/TeacherCopilotClient';

export const metadata = {
  title: 'Teacher Copilot | NIPUN Intelligence',
  description: 'Context-aware AI assistant that knows your classroom — groups, skill gaps, and ASER levels.',
};
