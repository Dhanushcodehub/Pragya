...
export default function DashboardClient({ userEmail }: DashboardClientProps) {
  ...
  const handleDeployLoop = async (promptText: string, attachment?: string) => {
    ...
    try {
          ...
          if (line.startsWith('data: ')) {
            ...
            if (dataStr) {
              try {
                ...
                console.error('[PRAGYA OS Client] JSON Parse Error:', err);
              }
            }
          }
        }
      ...
      console.error('[PRAGYA OS Client] SSE Stream Failure:', err);
      setOsState(prev => ({
        ...prev!,
        status: 'failed',
        phase: 'Failed',
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 pb-20 overflow-x-hidden">
      ...
      >
        ...
        >
          PRAGYA AI <span className="text-[#5a6ba8]">Operating System</span>
        </h1>
